...
class listener implements EventSubscriberInterface
{
    ...
    /**
     * Load existing translations from the database and assign to $row
     */
    ...
    /**
     * Assign existing translations to template vars for ACP edit form
     */
    public function assign_translation_data($event)
    {
        ...
        while ($row = $this->db->sql_fetchrow($result)) {
            $iso = $row['lang_iso'];
            if ($iso === $this->user->data['user_lang']) {
                continue;
            }
    ...
    /**
     * Replace forum names/descs on index.php
     */
    ...
    /**
     * Replace forum title on viewforum.php
     */
